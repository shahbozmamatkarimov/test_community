            ...
            >
              <div class="shadow overflow-hidden rounded-lg">
                <table class="min-w-full text-sm">
                  ...
                  <tbody
                    v-if="isLoading.isLoadingType('getAllData/true_answers')"
                  ...
                  <tbody v-else class="bg-gray-800">
                    ...
                    >
                      ...
                      >
                        <p class="font-medium truncate w-40">{{ i.student_id }}</p>
                      </td>
                ...
                <div
                  v-if="
                    !isLoading.isLoadingType('getAllData/true_answers') &&
...
<script setup>
import { useLoadingStore, useResultsStore } from "@/store";
